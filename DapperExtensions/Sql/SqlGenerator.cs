...
namespace DapperExtensions.Sql
{
    public interface ISqlGenerator
    {
        ...
        string Update(IClassMapper classMap, IPredicate predicate, IDictionary<string, object> parameters, Func<IPropertyMap, bool> propertyPredicate = null);
    ...
    public class SqlGeneratorImpl : ISqlGenerator
    {
        ...
        public virtual string Update(IClassMapper classMap, IPredicate predicate, IDictionary<string, object> parameters, Func<IPropertyMap, bool> propertyPredicate = null)
        {
            if (predicate == null)
            {
            ...
            {
                propertyPredicate = p => !(p.Ignored || p.IsReadOnly || p.KeyType == KeyType.Identity);
            }
